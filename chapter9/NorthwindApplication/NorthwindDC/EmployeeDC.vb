...
#End Region
    ...
    Public Function GetBusinessRules() As NorthwindShared.Errors.BusinessErrors Implements NorthwindShared.Interfaces.IBaseInterface.GetBusinessRules
        Dim objBusRules As New BusinessErrors
        With objBusRules
            .Add("Last Name", "The value cannot be null.")
            .Add("Last Name", "The value cannot be more than 20 characters " _
            & "in length.")
            .Add("First Name", "The value cannot be null.")
            .Add("First Name", "The value cannot be more than 10 characters " _
            & "in length.")
            .Add("Title", "The value cannot be null.")
            .Add("Title", "The value cannot be more than 30 characters " _
            & "in length.")
            .Add("Title Of Courtesy", "The value cannot be more than 25 " _
            & "characters in length.")
            .Add("Title Of Courtesy", "The value must one of the " _
            & "following: Mr., Ms., Dr. or Mrs.")
            .Add("Birth Date", "The value cannot be a date in the future.")
            .Add("Birth Date", "The employee must be 18 years of age or " _
            & "older.")
            .Add("Birth Date", "The employee must be younger than 60 years " _
            & "of age.")
            .Add("Hire Date", "The value may not be more than two weeks in " _
            & "the future.")
            .Add("Hire Date", "The value may not be before the company " _
            & "was created.")
            .Add("Address", "The value cannot be null.")
            .Add("Address", "The value cannot be more than 60 characters " _
            & "in length.")
            .Add("City", "The value cannot be null.")
            .Add("City", "The value cannot be more than 15 characters in " _
            & "length.")
            .Add("Region", "The value cannot be more than 15 characters in " _
            & "length.")
            .Add("Postal Code", "The value cannot be more than 10 " _
            & "characters in length.")
            .Add("Country", "The value cannot be more than 15 characters " _
            & "in length.")
            .Add("Home Phone", "The value cannot be null.")
            .Add("Home Phone", "The value cannot be more than 24 characters " _
            & "in length.")
            .Add("Extension", "The value cannot be more than 4 characters " _
            & "in length.")
            .Add("Photo Path", "The value cannot be more than 255 " _
            & "characters in length.")
        End With
    ...
    Public Function Save(ByVal sEmployee As NorthwindShared.Structures.structEmployee, ByRef intID As Integer) As NorthwindShared.Errors.BusinessErrors Implements NorthwindShared.Interfaces.IEmployee.Save
        Dim strCN As String = ConfigurationSettings.AppSettings("Northwind_DSN")
        Dim cn As New SqlConnection(strCN)
        Dim cmd As New SqlCommand
