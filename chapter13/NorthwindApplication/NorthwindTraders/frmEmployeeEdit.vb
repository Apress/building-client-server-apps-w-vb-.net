...
#End Region
    ...
    ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim locRes As New ResourceManager("NorthwindTraders", Me.GetType().Assembly)
        ...
        Me.lblPostalCode.Text = locRes.GetString("POSTAL_CODE")
        Me.lblCountry.Text = locRes.GetString("COUNTRY")
        Me.lblPhoto.Text = locRes.GetString("PHOTO")
        Me.lblNotes.Text = locRes.GetString("NOTES")
        Me.lblAssigned.Text = locRes.GetString("SELECTED_TER")
        Me.lblAvailable.Text = locRes.GetString("AVAILABLE_TER")
        Me.btnOK.Text = locRes.GetString("OK")
        Me.btnCancel.Text = locRes.GetString("CANCEL")
...
#End Region
    ...
    BusinessRules.Errors.BusinessErrors) Handles mobjEmployee.Errs
        Try
            Dim i As Integer
            Dim ctl As Control
