<%@ Page Language="vb" AutoEventWireup="false" Codebehind="employees.aspx.vb" Inherits="NorthwindWeb.employees" enableViewState="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:DataGrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 80px; POSITION: absolute; TOP: 136px"
				...
				CellPadding="3" GridLines="Vertical" AutoGenerateColumns="False" EnableViewState="False">
