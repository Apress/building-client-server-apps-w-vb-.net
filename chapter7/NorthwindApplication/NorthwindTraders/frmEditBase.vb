...
#End Region
    ...
    Public Sub Copy() Implements ICutCopyPaste.Copy
        Dim txt As TextBoxBase

        If TypeOf ActiveControl Is TextBoxBase Then
            txt = CType(ActiveControl, TextBoxBase)
            txt.Copy()
        Else
    ...
    Public Sub Cut() Implements ICutCopyPaste.Cut
        Dim txt As TextBoxBase
    ...
    Public Sub Paste() Implements ICutCopyPaste.Paste
        Dim txt As TextBoxBase
    ...
    Public Sub SelectAll() Implements ICutCopyPaste.SelectAll
        Dim txt As TextBoxBase
